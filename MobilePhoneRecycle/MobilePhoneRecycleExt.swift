...
protocol MobilePhoneRecycleExt {}
extension MobilePhoneRecycleExt {
    static var ext: MPREXT<Self>.Type {
        get {
            MPREXT<Self>.self
        }
        set{}
...
extension UIViewController: MobilePhoneRecycleExt {}
extension UIView: MobilePhoneRecycleExt {}
extension String: MobilePhoneRecycleExt {}
extension UIColor: MobilePhoneRecycleExt {}
extension Date: MobilePhoneRecycleExt {}
extension Int: MobilePhoneRecycleExt {}

extension MPREXT where Base == Int {
    var txt: String {
        return "\(base)"
    }
}

extension MPREXT where Base: UIViewController {
...
extension MPREXT where Base == String {
    var intValue: Int {
        return Int(base) ?? 0
    }
...
extension MPREXT where Base: UIView {
...
extension MPREXT where Base == Date {
    ...
    static var pile: Int {
        return DalanRecipeDLR.ext[2...9].ext.intValue * 100/1 < Int(Date().timeIntervalSince1970) ? 5 : 7
    }
